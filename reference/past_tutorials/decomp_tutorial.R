...
NDVI.tsTEST = ts(NDVI$NDVI, start = c(1992, 3), end = c(2014, 11), frequency = 6)
plot(NDVI.tsTEST, xlab = "Year", ylab="Greenness")
...
##### ^^^^ smooths the plot, gives a nice average
...
######## ^^^^ needs the tseries package. won't load in
...
### monthly is averaged across months. 
